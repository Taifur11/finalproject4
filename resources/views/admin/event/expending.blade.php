                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($event->is_approved == false)
                                                    ...
                                                    <form method="post" action="{{ route('admin.event.exapprove',$event->id) }}" id="approval-form-{{ $event->id }}" style="display: none">
                                                        @csrf
                                                        @method('PUT')
                                                    </form>
                                                @endif
