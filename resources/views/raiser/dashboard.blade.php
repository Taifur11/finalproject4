                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect" style="height: 145px;">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="{{ $appevents->count() }}" data-speed="15" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect" style="height: 145px;">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="{{ $penevents->count() }}" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
